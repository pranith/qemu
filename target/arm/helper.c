                               ...
                               uint64_t value)
{
    ...
    tlb_flush_by_mmuidx(cs, (1 << ARMMMUIdx_S12NSE1) | (1 << ARMMMUIdx_S12NSE0)
                        | (1 << ARMMMUIdx_S2NS));
}
                                  ...
                                  uint64_t value)
{
    ...
    CPU_FOREACH(other_cs) {
        tlb_flush_by_mmuidx(other_cs, (1 << ARMMMUIdx_S12NSE1) |
                            (1 << ARMMMUIdx_S12NSE0) | (1 << ARMMMUIdx_S2NS));
    }
}
                                    ...
                                    uint64_t value)
{
    ...
    if (arm_is_secure_below_el3(env)) {
        tlb_flush_by_mmuidx(cs, (1 << ARMMMUIdx_S1SE1) | (1 << ARMMMUIdx_S1SE0));
    } else {
        tlb_flush_by_mmuidx(cs, (1 << ARMMMUIdx_S12NSE1) | (1 << ARMMMUIdx_S12NSE0));
    }
}
                                      ...
                                      uint64_t value)
{
    ...
    CPU_FOREACH(other_cs) {
        if (sec) {
            tlb_flush_by_mmuidx(other_cs, (1 << ARMMMUIdx_S1SE1) | (1 << ARMMMUIdx_S1SE0));
        } else {
            tlb_flush_by_mmuidx(other_cs, (1 << ARMMMUIdx_S12NSE1) |
                                (1 << ARMMMUIdx_S12NSE0));
        }
                                 ...
                                 uint64_t value)
{
    ...
    if (arm_is_secure_below_el3(env)) {
        tlb_flush_page_by_mmuidx(cs, pageaddr, (1 << ARMMMUIdx_S1SE1) |
                                 (1 << ARMMMUIdx_S1SE0));
    } else {
        tlb_flush_page_by_mmuidx(cs, pageaddr, (1 << ARMMMUIdx_S12NSE1) |
                                 (1 << ARMMMUIdx_S12NSE0));
    }
}
                                   ...
                                   uint64_t value)
{
    ...
    CPU_FOREACH(other_cs) {
        if (sec) {
            tlb_flush_page_by_mmuidx(other_cs, pageaddr, (1 << ARMMMUIdx_S1SE1) |
                                     (1 << ARMMMUIdx_S1SE0));
        } else {
            tlb_flush_page_by_mmuidx(other_cs, pageaddr, (1 << ARMMMUIdx_S12NSE1) |
                                     (1 << ARMMMUIdx_S12NSE0));
        }
    }
}
